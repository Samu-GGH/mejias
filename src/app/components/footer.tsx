...
const Footer = () => {
  return (
    <footer className="BGCcomponent text-white relative flex flex-wrap justify-evenly place-content-start place-items-center h-84 md:h-45 w-full p-4">
      <div className="title-container relative flex flex-wrap w-full justify-center mb-3">
        <div className="text-4xl font-bold mb-3">
          <Link href="/">Mejias</Link>
        </div>
        <div className="md:hidden bg-white absolute w-full h-0.5 bottom-0"></div>
      </div>
      <div className="footer-links relative w-full md:w-[45%] md:h-20 flex justify-center lg:place-items-center">
        <div className="hidden md:inline bg-white absolute w-[90%] h-0.5 -top-3"></div>
        <ul className="list-links_footer relative w-full text-center mb-2 md:m-0 flex flex-wrap md:justify-evenly text-white">
          <li className="relative md:inline-block w-full md:w-fit text-center mb-2 md:mr-2 hover:bg-white rounded-sm transition-all duration-200 hover:text-[#f11515] hover:font-bold">
            <Link href="">
              <span className="first-child">Contacto </span>
            </Link>
          </li>
      ...
      <div className="absolute md:relative flex flex-wrap bottom-2 md:bottom-0 justify-evenly place-content-center w-full md:w-[45%] h-20 z-200">
        <div className="hidden md:inline bg-white absolute w-[90%] h-0.5 -top-3"></div>
        <span className="text-white text-center text-sm w-full mb-4">
          Siguenos en nuestras redes
        </span>
        <Link
          href="https://www.instagram.com/escuelamejiafmm?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
          className="facebook w-[22%] flex justify-center"
        >
          <svg
        ...
        <Link
          href="https://www.instagram.com/escuelamejiafmm?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
          className="instagram w-[22%] flex justify-center"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
        ...
        <Link
          href="https://www.instagram.com/escuelamejiafmm?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
          className="x w-[22%] flex justify-center"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
        ...
        <Link
          href="https://www.instagram.com/escuelamejiafmm?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
          className="whatsapp w-[22%] flex justify-center"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
