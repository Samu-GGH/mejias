  ...
  return (
    <main className="relative flex flex-col">
      ...
      <div className="content h-fit mb-16 lg:pt-2">
        <Carrousel />
        <div className="calenderContainer relative block mt-3 mb-20">
          <span className="relative block pl-4 pr-4 md:pl-12 md:pr-12 lg:pl-18 lg:pr-18 text-[16px] lg:text-[24px] font-bold">
            Calendario
          </span>
          <Calender />
          <div className="masCalendario absolute inline-flex flex-wrap items-center justify-center mt-3 w-25 p-1 text-[12px] md:text-[16px] border-black border-2 rounded-2xl right-[5%] lg:right-[50%] lg:translate-x-[50%] cursor-pointer font-bold hover:bg-[#f11515] hover:text-white hover:border-red-950 transition-all duration-150 ease-out">
        ...
        <div className="noticiasContainer relative block mt-3 ">
          <span className="relative block pl-4 pr-4 md:pl-12 md:pr-12 lg:pl-18 lg:pr-18 text-[16px] lg:text-[24px] font-bold">
            Noticias
          </span>
          <Newscontainer />
